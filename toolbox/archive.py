...
class Training:
    ...
    def from_config(cls, config_dir, input_filename):
        sample = cls()
        sample._config = tissue.Sample.periodic_tissue(
    ...
    def minimize_config(self):
        ...
        self._config = tissue.Sample.periodic_tissue(
    ...
    def single_iteration(self):
        ...
        print("Step 0: Identify all cells as self._modified_cells. Load cell parameters.")
