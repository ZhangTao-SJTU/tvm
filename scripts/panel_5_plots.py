...
def error_to_iters_small():
    for l in [5,6]:
        savefile = "Panels/Panel_5/error_to_iters_spheroid_l_{}_n_5.png".format(l)
        label_to_data = {}
        # title = r"$n_{total} = $"+"{}".format(l**3)
...
def s0_histogram_spheroid_small():
    input_filename = "final_s0.txt"
    for l in [5,6]:
        label_to_data = {}
...
def final_iteration_to_final_overlap_small():
    for l in [5,6]:  
        savefile = "Panels/Panel_5/final_iterations_to_final_overlap_l_{}_n_5.png".format(l)
        label_to_dir = {}
        # for n in [1,2,3,4,5,6]:
        for n in [5]:
