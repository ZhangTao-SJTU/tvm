    ...
    for n in [2,3,4]:
        for pattern in n_cell_to_patterns[n]:
            ...
            for dir in dirlist:
                ...
                savefile = output_folder+"{:03d}_error_s0.png".format(int(os.path.basename(os.path.dirname(dir))))
                label_to_data = {}
                label_to_data["Error"] = {"x": iters, "y": costs, "loc": "top"}
                ...
                savefile = output_folder+"{:03d}_overlap_s0.png".format(int(os.path.basename(os.path.dirname(dir))))
                label_to_data = {}
